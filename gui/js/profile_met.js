        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                for(i=devices_set.length-1; i>=0;i--){
                    ...
                    road_temp_lb=devices_set[i].RoadTempLb
			        road_temp_ub=devices_set[i].RoadTempUb
			        road_temp_pr=devices_set[i].RoadTempPr
					vis_dist_lb=devices_set[i].VisibilityDistLb
			        vis_dist_ub=devices_set[i].VisibilityDistUb
			        vis_dist_pr=devices_set[i].VisibilityDistPr
			        ppt_lb=devices_set[i].HumidityLb
			        ppt_ub=devices_set[i].HumidityUb
			        ppt_pr=devices_set[i].HumidityPr
			        air_temp_lb=devices_set[i].AirTempLb
			        air_temp_ub=devices_set[i].AirTempUb
			        air_temp_pr=devices_set[i].AirTempPr
...
function editRow(){
	...
	$.ajax({
		...
		data :{profileID:profileID,scn:scn,shortDescription:shortDescription,longDescription:longDescription,sun_from:sun_from,sun_to:sun_to,mon_from:mon_from,mon_to:mon_to,tue_from:tue_from,tue_to:tue_to,wed_from:wed_from,wed_to:wed_to,thu_from:thu_from,thu_to:thu_to,fri_from:fri_from,fri_to:fri_to,sat_from:sat_from,sat_to:sat_to,RoadTempLb:RoadTempLb,RoadTempUb:RoadTempUb,RoadTempPr:RoadTempPr,VisibilityDistLb:VisibilityDistLb,VisibilityDistUb:VisibilityDistUb,VisibilityDistPr:VisibilityDistPr,PrecipitationLb:PrecipitationLb,PrecipitationUb:PrecipitationUb,PrecipitationPr:PrecipitationPr,AirTempLb:AirTempLb,AirTempUb:AirTempUb,AirTempPr:AirTempPr,WindSpeedLb:WindSpeedLb,WindSpeedUb:WindSpeedUb,WindSpeedPr:WindSpeedPr},
		type: 'POST',
		success: function(result) {
