<?php
  ...
  $pdf->AddPage('L');
    ...
    $query= "SELECT t2.SystemCodeNumber AS SCN,t1.online AS IsOnline,t2.LastUpdated AS Last_Updated_Last,t1.LastUpdated AS Last_Updated_Old FROM tis_vms_fault AS t2,tis_vms_fault AS t1 WHERE t1.SystemCodeNumber = t2.SystemCodeNumber AND TIMESTAMPDIFF(minute,t1.lastUpdated,t2.LastUpdated) = t2.time AND t1.LastUpdated >= '$from' AND t1.LastUpdated <= '$to'" ;
