...
try {
	...
	$handle=$link->prepare("INSERT INTO `utmc_detector_profile_data`(`ShortDescription`, `LongDescription`, `SystemCodeNumber`, `TotalFlowLb`, `TotalFlowPr`, `TotalFlowUb`, `SpeedLb`, `SpeedPr`, `SpeedUb`, `FromTimeSun`, `ToTimeSun`, `FromTimeMon`, `ToTimeMon`, `FromTimeTue`, `ToTimeTue`, `FromTimeWed`, `ToTimeWed`, `FromTimeThu`, `ToTimeThu`, `FromTimeFri`, `ToTimeFri`, `FromTimeSat`, `ToTimeSat`) VALUES ('$shortDescription','$longDescription','$scn','$RoadTempLb','$RoadTempPr','$RoadTempUb','$PrecipitationLb','$PrecipitationPr','$PrecipitationUb','$sun_from','$sun_to','$mon_from','$mon_to','$tue_from','$tue_to','$wed_from','$wed_to','$thu_from','$thu_to','$fri_from','$fri_to','$sat_from','$sat_to')");
	$handle->execute();
	return "success";
}
